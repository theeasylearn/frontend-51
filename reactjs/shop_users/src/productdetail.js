                            ...
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="product-info-img" data-aos="fade-right">
                                        <img src="theme/assets/images/homepage-one/product-img/product-img-14.webp" className="img-fluid rounded" alt="Product" />
                                    </div>
                                </div>
                                        ...
                                        <table className="table table-striped fs-3">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Premium professional coat with stunning rainbow sequins. Perfect for events and fashion showcases. High quality breathable lining.</td>
                                                </tr>
                                            </tbody>
                                        </table>
